<template>
    <div>
        <div style="margin-bottom: 5px;">
            ...
            <el-select v-model="storage" placeholder="请选择书架" style="margin-left: 5px;">
                <el-option
        ...
        >
            ...
            <el-table-column prop="storage" label="书架" width="180" :formatter="formatStorage">
            </el-table-column>
        ...
        <el-dialog
            ...
            <el-form ref="form" :rules="rules" :model="form" label-width="80px">
                ...
                <el-form-item label="书架" prop="storage">
                    <el-col :span="20">
                        <el-select v-model="form.storage" placeholder="请选择书架" style="margin-left: 5px;">
                            <el-option
                                    v-for="item in storageData"
                                    :key="item.id"
                                    :label="item.name"
        ...
        data() {
            ...
            return {
                ...
                rules: {
                    ...
                    storage:[
                        {required: true, message: '请选择书架', trigger: 'blur'}
                    ],
                    goodstype:[
