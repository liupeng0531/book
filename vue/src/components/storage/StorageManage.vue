<template>
    <div>
        <div style="margin-bottom: 5px;">
            <el-input v-model="name" placeholder="请输入书架名" suffix-icon="el-icon-search" style="width: 200px;"
        ...
        >
            ...
            <el-table-column prop="name" label="书架名" width="180">
            </el-table-column>
        ...
        <el-dialog
            ...
            <el-form ref="form" :rules="rules" :model="form" label-width="80px">
                <el-form-item label="书架名" prop="name">
                    <el-col :span="20">
